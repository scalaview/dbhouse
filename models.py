...
class DailyPrice(BaseModel):
    ...
    evm_7 = Column(Numeric(precision=8, scale=2, asdecimal=False, decimal_return_scale=None), default=0.00)
    evm_14 = Column(Numeric(precision=8, scale=2, asdecimal=False, decimal_return_scale=None), default=0.00)
    cci_30 = Column(Numeric(precision=8, scale=2, asdecimal=False, decimal_return_scale=None), default=0.00)
    roc_30 = Column(Numeric(precision=8, scale=2, asdecimal=False, decimal_return_scale=None), default=0.00)
    forceIndex_7 = Column(Numeric(precision=8, scale=2, asdecimal=False, decimal_return_scale=None), default=0.00)
